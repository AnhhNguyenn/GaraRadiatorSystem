...
namespace GarageRadiatorERP.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductHoseSpecs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InnerDiameter = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    OuterDiameter = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductHoseSpecs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductHoseSpecs_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CoreWidth = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    CoreHeight = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    CoreThickness = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Rows = table.Column<int>(type: "int", nullable: true),
                    Material = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TankType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVehicleMaps", x => new { x.ProductId, x.VehicleId });
                    table.ForeignKey(
                        name: "FK_ProductVehicleMaps_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVehicleMaps_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductHoseSpecs_ProductId",
                table: "ProductHoseSpecs",
                column: "ProductId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVehicleMaps_VehicleId",
